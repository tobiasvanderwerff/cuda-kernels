...
#define SIMTIME 1000  // in ms, for when no input file is provided , time in msec when you do not have an input file
...
#define PRINTSTATE 1	//	flag enabling dumping of the final states of the neurons (search for it in results folder)
...
//typedef double mod_prec;	//BE VERY CAREFUL TO CHECK ALL SCANFS TO BE SURE YOU SCAN FOR DOUBLE-POINT ACCURACY, KNOWN ISSUE WITH COND VALUES) AND MPI_TYPES
